...
import { AuthSecret } from '../src/infra/shared/cross-account-auth-secret';

test('AuthSecret cdk-nag AwsSolutions Pack', () => {
  ...
  const stack = new AuthSecret(app, 'AuthSecret', { env });
